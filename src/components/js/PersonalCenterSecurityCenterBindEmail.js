...
root.name = 'PersonalCenterSecurityCenterBindEmail'
...
root.created = function () {
  this.$store.commit('changeMobileHeaderTitle', '绑定邮箱');
  ...
  if (data.errorCode) {
    switch (data.errorCode) {
      ...
      case 3:
        ...
        break;
      case 4:
        this.verificationCodeWA = this.$t('emailWA_6')
        break;
      default:
...
root.methods.re_commit = function (data) {
  ...
  if (data.errorCode) {
    switch (data.errorCode) {
      case 1:
        this.emailWA = this.$t('emailWA_1')
        break;
      case 2:
        this.emailWA = this.$t('emailWA_4')
        break;
      case 3:
        this.pswWA = this.$t('emailWA_5')
        break;
      default:
