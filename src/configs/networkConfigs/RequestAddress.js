...
requestAddress.POST_FOLLOWUSER= {url: urlHead+'/follow/user/listFollowUser', method: 'post'}  //大佬跟单者
requestAddress.POST_FOLLOWUSER_LIST= {url: urlHead+'/follow/listFollowUser', method: 'post'}  //用户跟单者
requestAddress.POST_MY_USER= {url: urlHead+'/follow/user/myFollowList', method: 'post'}  //我的镜像交易
requestAddress.POST_DEL_FOLLOWER= {url: urlHead+'/follow/user/delFollower', method: 'post'}  //取消跟单
